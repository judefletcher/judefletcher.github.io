        ...
        if (typeof google != 'undefined') {
            ...
            if (mapCanvasDefault.length) {
                mapCanvasDefault.googleMap({
                    zoom: 18, // Initial zoom level (optiona
                ...
                mapCanvasDefault.addMarker({
                    coords: [51.7590219, -1.2643449], // GPS coords ,
                    title: 'Oxford Africa Conference',
                    text: 'Blavatnik School of Government, University of Oxford',
                    icon: csi_path + '/assets/img/map/pointer.png'
                });
            }
            ...
            if (mapCanvasDefault.length) {
                mapCanvasDefault.googleMap({
                    zoom: 18, // Initial zoom level (optiona
                    coords: [51.7590219, -1.2643449], // Map center (optional)
